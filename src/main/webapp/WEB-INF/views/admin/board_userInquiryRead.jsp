						...
						<ul>
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a href="/admin/board/inquiry/${page}/modifyReply/${inquiry.seqKey}" class="nbtnbig mw">답변수정</a></li>
								</c:otherwise>
							</c:choose>
							<li><a href="/admin/board/inquiry" class="sbtnMini mw">목록</a></li>
						</ul>
					</div>
				</div>
				<!-- //Btn Area -->
							...
							<tbody>
								<c:forEach var="inquiry" items="${inquiryList}">
									<tr>
										...
										<td class="left"><a href="/admin/board/inquiry/${page}/read/${inquiry.seqKey}">${inquiry.title}</a></td>
										<td class="tnone">
											<fmt:parseDate var="createdDate" value="${inquiry.createdDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
											<fmt:formatDate value="${createdDate}" pattern="yyyy-MM-dd"/>
										</td>
