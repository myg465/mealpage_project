	...
	<main>
		<div id="outbox">
			...
			<div id="contents">
				...
				<form action="/admin/board/inquiry/${page}/reply/${key}" method="post">
					<!-- 답변 -->
					<div class="answer">
						<div class="inbox">
							<div class="atxt">
								<textarea class="tta" name="reply" maxlength=10000 required></textarea>
							</div>
						</div>
					</div>
					<!-- //답변 -->
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								<li><button type="reset" class="nbtnbig mw no-outline" style="cursor: pointer;">취소</a></li>
								<li><button type="submit" class="sbtnMini mw no-outline" style="cursor: pointer;">확인</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
